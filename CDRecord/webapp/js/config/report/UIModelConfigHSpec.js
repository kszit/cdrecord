//  =======================================================================================
	...
	var grid, record;
	var saveUrl = content_path+"/reportConfig/uiModelConfig_save.action";
	var dataUrl = content_path+"/reportConfig_json/uiModelJson.action?headerRowModel.reportBindid="+reportid+"&headerRowModel.bindId="+hbindid;
	...
	function createGrid() {
		...
		var headerDataFrom =  new Ext.data.JsonStore({
		      fields: ['name', 'bindId'],
		      root:'data',
		      url:comBoxDataSource+uiModelbindid
		});
		headerDataFrom.load();
		...
		grid.on("cellclick", function(grid, rowIndex, columnIndex, e) {
			...
			if(columnIndex==7 || columnIndex==8) {
				...
				case 7: //UI model 配置信息
					url = content_path+'/reportConfig/verticalConfigC_uiModelConfigPage.action?verticalColumnModel.bindId='+rowBindid+'&verticalColumnModel.reportid='+reportid;
					break;  
				case 8: //数据来源（计算方式）
					url = content_path+'/reportConfig/verticalConfigC_dataFromConfigPage.action?verticalColumnModel.bindId='+rowBindid+'&verticalColumnModel.reportid='+reportid;
					break;  
				default: 
					alert("other");
				}
