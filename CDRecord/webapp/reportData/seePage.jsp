...
<table width=100%>
	...
	<div>
		...
		<s:if test="user.roleId=='972'">
			<button onclick="setReportToBack('<s:property value="dataReportModel.bindId"/>');return false;" class='cdrecordButton'>回退</button>
			<button onclick="setReportToPublish('<s:property value="dataReportModel.bindId"/>');return false;" class='cdrecordButton'>上报</button>
		</s:if>
	</div>
	...
	<div style="width: 80%; margin-left: auto; margin-right: auto;">
		...
		<table width=100% align='center' class='seeReportTable'><s:text name="reportTableHtmlCode"/></table>
