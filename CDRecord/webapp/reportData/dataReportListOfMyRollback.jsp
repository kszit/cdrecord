...
<button class="cdrecordButton" onclick="window.open(content_path+'/reportConfig/reportConfig_selectReportPage.action');return false;">添加</button>
<input type='submit' class="cdrecordButton" value='删除'></input>
	...
	%>   <!-- 
		...
		<display:column property="periodsName" style="width:5%"  title="期限"></display:column>
	     ...
	     <display:column property="verifyName" title="流程状态" style="width:15%" ></display:column>
