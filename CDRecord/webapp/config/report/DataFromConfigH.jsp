...
var BrothersReportData = 121;//兄弟表数据
	...
	function submitForm() {
		...
		document.getElementById('headerRowModel_dataRule').value = dataRule;
		document.getElementById('headerRowModel_dataRuleItems').value = dataItems;
		...
		//alert($('#dataFromSaveH').ajaxSubmit());
		$('#dataFromSaveH').ajaxSubmit(options);
		*/
		return false;
	}
	//选择单元格页面
...
{	
	...
	function getSelectedDataFrom(){
		var dataFrom = document.getElementById('headerRowModel_dataFrom').value;
		return dataFrom;
	}
...
Ext.onReady(function() {	
	...
	function setDataFromMainPage(node){
		var bindId = document.getElementById('headerRowModel_reportBindid').value;
		var getDataFromHtmlUrl = content_path+"/reportConfig/dataFromConfig_dataFromConfigHtml.do?param2="+bindId+"&param1="+node.id
		Ext.Ajax.request({
		...
		document.getElementById('headerRowModel_dataFrom').value=node.id;
		//currentNode = node;
		return false;
	}
...
<body>
	...
	<s:form id='dataFromSaveH' action="/reportConfig_json/dataFromSaveH.action" method="post"
		theme='simple'>
		<s:hidden name='headerRowModel.bindId' id='headerRowModel_bindId'></s:hidden>
		<s:hidden name='headerRowModel.reportBindid' id='headerRowModel_reportBindid'></s:hidden>
		<s:hidden name='headerRowModel.dataFrom' id='headerRowModel_dataFrom'></s:hidden>
		<s:hidden name='headerRowModel.dataRule' id='headerRowModel_dataRule'></s:hidden>
		<s:hidden name='headerRowModel.dataRuleItems' id='headerRowModel_dataRuleItems'></s:hidden>
