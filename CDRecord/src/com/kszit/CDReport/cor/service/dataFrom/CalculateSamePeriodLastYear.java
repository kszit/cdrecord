 ...
 *
 */
public class CalculateSamePeriodLastYear extends CalculateAbatract{
	public CalculateSamePeriodLastYear(){
		super();
	}
	public CalculateSamePeriodLastYear(HVConfigDataFromPO datafromPo,
...
//		year = (Integer.parseInt(year)-1)+"";
	...
	public String getDataFromHtml(String reportLinkBindid) {
		...
		sb.append("CalculateSamePeriodLastYear.js****");
	...
	public String getCellDataFromHtml(String reportLinkid) {
		String url = "/config/report/selectReportPart.jsp";
		StringBuffer sb = new StringBuffer();
		sb.append("CalculateSamePeriodLastYearOfCell.js****");
