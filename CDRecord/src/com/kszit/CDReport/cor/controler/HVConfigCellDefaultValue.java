 ...
 */
public class HVConfigCellDefaultValue extends ReportCDSupport {
	...
	HVConfigCellDValueModel cellValue = new HVConfigCellDValueModel();
	public HVConfigCellDValueModel getCellValue() {
		return cellValue;
	}
	public void setCellValue(HVConfigCellDValueModel cellValue) {
	...
	* @since  -
	 */
	public String cellDefaultValueForm(){ 
		
		return "cellValuePage";
	}
	/**
	 *  保存设置的单元格默认值
	* @since  -
	 */
	public String oneCellValueSave(){ 
		HVConfigCellDValueService cellValueServer = new  HVConfigCellDValueService();
		cellValueServer.save(cellValue);
		return "oneCellValuePage";
	}
